...
import { LazyJsonString as __LazyJsonString, expectNumber as __expectNumber, expectString as __expectString, handleFloat as __handleFloat, } from "@aws-sdk/smithy-client";
...
export var deserializeAws_json1_1AnalyzeExpenseCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_json1_1AnalyzeExpenseCommandError(output, context)];
                }
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                data = _a.sent();
        ...
        switch (_m.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "InvalidKMSKeyException": return [3 /*break*/, 8];
                    case "com.amazonaws.textract#InvalidKMSKeyException": return [3 /*break*/, 8];
                    case "InvalidParameterException": return [3 /*break*/, 10];
                    case "com.amazonaws.textract#InvalidParameterException": return [3 /*break*/, 10];
                    case "InvalidS3ObjectException": return [3 /*break*/, 12];
                    case "com.amazonaws.textract#InvalidS3ObjectException": return [3 /*break*/, 12];
